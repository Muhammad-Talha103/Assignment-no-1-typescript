...
let age2 = 55
if (age < 2) {
    console.log("Age " +age2 + " The person is a baby.");
} else if (age < 4) {
    console.log("Age "+age2 + " The person is a toddler.");
} else if (age < 13) {
    console.log("Age "+age +" The person is a kid.");
} else if (age < 20) {
    console.log("Age "+age2 + "The person is a teenager.");
} else if (age < 65) {
    console.log("Age " +age2 + " The person is an adult.");
} else {
    console.log("Age " +age2 + " The person is an elder.");
}
